...
PRESET = {'communication': {'default_mode': 'CANFD', 'default_launch_count': 4},
 ...
 'motion': {'default_home_time': 5.0,
            ...
            'cycle_sequence': 'sequences.runtime_default_cycle'},
 'grasp': {'mode': 'repeat',
           'repeat_count': 3,
           'repeat_sequence': 'sequences.runtime_default_repeat',
           'hold_grip_sequence': 'sequences.runtime_default_hold_grip',
           'hold_release_sequence': 'sequences.runtime_default_hold_release'},
