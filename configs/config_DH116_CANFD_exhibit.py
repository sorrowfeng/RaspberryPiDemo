...
CYCLE_MOVE_POSITIONS = [
    {"positions": [10000, 0, 0, 0, 0, 0], "interval": DEFAULT_CYCLE_INTERVAL},
    {"positions": [0, 10000, 0, 0, 0, 0], "interval": DEFAULT_CYCLE_INTERVAL},
    {"positions": [0, 0, 0, 0, 0, 0], "interval": DEFAULT_CYCLE_INTERVAL},
    {"positions": [0, 0, 10000, 0, 0, 0], "interval": DEFAULT_CYCLE_INTERVAL},
    {"positions": [0, 0, 0, 10000, 0, 0], "interval": DEFAULT_CYCLE_INTERVAL},
    {"positions": [0, 0, 0, 0, 10000, 0], "interval": DEFAULT_CYCLE_INTERVAL},
    {"positions": [0, 0, 0, 0, 0, 10000], "interval": DEFAULT_CYCLE_INTERVAL},
    {"positions": [0, 0, 0, 0, 10000, 0], "interval": DEFAULT_CYCLE_INTERVAL},
    {"positions": [0, 0, 0, 10000, 0, 0], "interval": DEFAULT_CYCLE_INTERVAL},
    {"positions": [0, 0, 10000, 0, 0, 0], "interval": DEFAULT_CYCLE_INTERVAL},
    {"positions": [0, 0, 0, 0, 0, 0], "interval": DEFAULT_CYCLE_INTERVAL},
