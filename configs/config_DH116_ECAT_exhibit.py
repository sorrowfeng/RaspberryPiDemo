...
MOTION_CONFIG = {
    ...
    "cycle_move_positions": [
        {"positions": [10000, 0, 0, 0, 0, 0], "interval": 0.7},
        {"positions": [0, 10000, 0, 0, 0, 0], "interval": 0.7},
        {"positions": [0, 0, 0, 0, 0, 0], "interval": 0.7},
        {"positions": [0, 0, 10000, 0, 0, 0], "interval": 0.7},
        {"positions": [0, 0, 0, 10000, 0, 0], "interval": 0.7},
        {"positions": [0, 0, 0, 0, 10000, 0], "interval": 0.7},
        {"positions": [0, 0, 0, 0, 0, 10000], "interval": 0.7},
        {"positions": [0, 0, 0, 0, 10000, 0], "interval": 0.7},
        {"positions": [0, 0, 0, 10000, 0, 0], "interval": 0.7},
        {"positions": [0, 0, 10000, 0, 0, 0], "interval": 0.7},
        {"positions": [0, 0, 0, 0, 0, 0], "interval": 0.7},
