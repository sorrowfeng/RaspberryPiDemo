DISPLAY_NAME = 'DH116 / ECAT / exhibit'
...
PRESET = {'communication': {'default_mode': 'ECAT', 'default_launch_count': 1},
 ...
 'motion': {'default_home_time': 5.0,
            ...
            'cycle_sequence': 'sequences.dh116_ecat_exhibit_cycle'},
 'grasp': {'mode': 'repeat',
           'repeat_count': 3,
           'repeat_sequence': 'sequences.dh116_ecat_exhibit_repeat',
           'hold_grip_sequence': 'sequences.dh116_ecat_exhibit_hold_grip',
           'hold_release_sequence': 'sequences.dh116_ecat_exhibit_hold_release'},
